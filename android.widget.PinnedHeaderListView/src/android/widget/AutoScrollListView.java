...
public class AutoScrollListView extends ListView
{
	...
	public AutoScrollListView(final Context context)
	{
		super(context);
	}

	public AutoScrollListView(final Context context, final AttributeSet attrs)
	{
		super(context, attrs);
	}

	public AutoScrollListView(final Context context, final AttributeSet attrs, final int defStyle)
	{
	 ...
	 */
	public void requestPositionToScreen(final int position, final boolean smoothScroll)
	{
	...
	protected void layoutChildren()
	{
		...
		final int firstPosition = getFirstVisiblePosition() + 1;
		...
		else
		{
			...
			final int twoScreens = (lastPosition - firstPosition) * 2;
