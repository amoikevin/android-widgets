...
public class SwipeBackLayout extends FrameLayout
{
	...
	public SwipeBackLayout(final Context context, final AttributeSet attrs, final int defStyle)
	{
		...
		final int edgeSize = a.getDimensionPixelSize(R.styleable.SwipeBackLayout_edge_size, -1);
		if (edgeSize > 0)
			setEdgeSize(edgeSize);
		final int mode = EDGE_FLAGS[a.getInt(R.styleable.SwipeBackLayout_edge_flag, 0)];
		setEdgeTrackingEnabled(mode);

		final int shadowLeft = a.getResourceId(R.styleable.SwipeBackLayout_shadow_left,
				R.drawable.shadow_left);
		final int shadowRight = a.getResourceId(R.styleable.SwipeBackLayout_shadow_right,
				R.drawable.shadow_right);
		final int shadowBottom = a.getResourceId(R.styleable.SwipeBackLayout_shadow_bottom,
	 ...
	 */
	public void setSensitivity(final Context context, final float sensitivity)
	{
	 ...
	 * callback's {@link me.imid.swipebacklayout.lib.ViewDragHelper.Callback#onEdgeTouched(int, int)} and {@link me.imid.swipebacklayout.lib.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
	 ...
	 *        the swipe listener to attach to this view
	 */
	public void addSwipeListener(final SwipeListener listener)
	{
		if (mListeners == null)
	 ...
	 * @param listener
	 */
	public void removeSwipeListener(final SwipeListener listener)
	{
		if (mListeners == null)
			return;
		...
		public boolean tryCaptureView(final View view, final int i)
		{
			...
			if (ret)
			{
				...
				if (mListeners != null && !mListeners.isEmpty())
					for (final SwipeListener listener : mListeners)
